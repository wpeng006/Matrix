            ...
            public void onClick(View v) {
                ...
                database.child("user").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        //DataSnapshot represents "user" level in the db tree
                        if (dataSnapshot.hasChild(username) && Objects.equals
                                (password, dataSnapshot.child(username)
                                        .child("user_password").getValue())) {
