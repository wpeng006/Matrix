...
//        //default location
//        double latitude = 37.385044;
//        double longitude = -122.286671;
...
//        googleMap.addMarker(marker);
        ...
        CameraPosition cameraPosition = new CameraPosition.Builder()
                ...
                .tilt(30)     //the tile of camera to 30 degree
                 .build();
    ...
    //Store the image or get voice command into local disk
    @Override
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        switch (requestCode) {
            ...
            // to capture sentence from voice control
    ...
    private void setupBottomBehavior() {
        ...
        mEventImageLike.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //find the event and add 1 to like number
                ...
                if (currMarker != null && mEvent != null) {
                    mEvent.setEvent_like_number(number + 1);
                    currMarker.setTag(mEvent);
                }
            }
        });
